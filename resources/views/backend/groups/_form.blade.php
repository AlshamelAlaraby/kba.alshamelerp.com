        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input required value="{{old('active_num')?old('active_num'):(isset($record)?$record->active_num:'')}}" name="active_num" type="number" class="form-control">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label>عدد الاعبين الذين يمكن تصعيدهم</label>
                    <input required value="{{old('esclation_num')?old('esclation_num'):(isset($record)?$record->esclation_num:'')}}" name="esclation_num" type="number" class="form-control">
                </div>
            </div>
        </div>
    </div>
